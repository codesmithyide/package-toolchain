...
#ifndef GUARD_CODESMITHYIDE_PACKAGETOOLCHAINS_DEBIANPACKAGETOOLCHAINTESTS_HPP
#define GUARD_CODESMITHYIDE_PACKAGETOOLCHAINS_DEBIANPACKAGETOOLCHAINTESTS_HPP
